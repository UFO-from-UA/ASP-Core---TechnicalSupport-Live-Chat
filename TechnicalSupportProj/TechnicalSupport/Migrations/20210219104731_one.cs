...
namespace TechnicalSupport.Migrations
{
    public partial class one : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FirstName", "Password", "RoleId" },
                values: new object[] { new Guid("26be7a6e-8e5f-4dd4-8346-0c40bbbeca28"), "admin@mail.com", null, "123456", 1 });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FirstName", "Password", "RoleId" },
                values: new object[] { new Guid("a23447f3-aff9-4488-8d5b-49aa91c25dc3"), "bob@mail.com", null, "123456", 2 });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FirstName", "Password", "RoleId" },
                values: new object[] { new Guid("82703972-0242-48f0-a2e4-77dd30e387fe"), "sam@mail.com", null, "123456", 2 });
